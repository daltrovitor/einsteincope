...
export default function RifaClareamento() {
  const PIX_KEY = '5517997380962'; // Dummy or real pix key
    ...
    <main className="bg-[#F8F5EE] min-h-screen pt-32 pb-20">
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-[#4A2B1D] mb-4">Clareamento Caseiro Moldado no Consultório</h1>
          <p className="text-xl md:text-2xl text-[#8E5A3C] font-medium">Oferecido por CD3 Odontologia</p>
        </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border-4 border-[#8E5A3C] h-fit">
            ...
            <ul className="space-y-4 mb-8">
              {[
                ...
                'Em caso de sensibilidade, a doutora fará o acompanhamento necessário',
                'Com molheira e seringas inclusas',
                'Agendado diretamente no celular da doutora, que será enviado no whatsapp do ganhador'
              ].map((item, i) => (
