        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="space-y-12">
              <div className="group">
                <div className="flex justify-between items-end mb-4">
                  <span className="text-sm font-bold uppercase tracking-widest text-white/50">Progresso da Campanha</span>
                  <span className="text-3xl font-display italic text-primary">0%</span>
                </div>
              ...
              <div className="group">
                <div className="flex justify-between items-end mb-4">
                  <span className="text-sm font-bold uppercase tracking-widest text-white/50">Engajamento Inicial</span>
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="p-12 border border-white/10 rounded-[3rem] bg-white/[0.02] backdrop-blur-xl">
              <div className="text-8xl md:text-[10rem] font-bold tracking-tighter mb-4">
                <Counter end={1000} />
              </div>
              <span className="text-sm font-bold uppercase tracking-[0.4em] text-white/60">Kg (Meta de Arrecadação)</span>
            </div>
            ...
            <div className="p-12 border border-white/10 rounded-[3rem] bg-white/[0.02] backdrop-blur-xl">
              ...
              <span className="text-sm font-bold uppercase tracking-[0.4em] text-white/60">Famílias (Meta de Impacto)</span>
            </div>
          </div>
        </div>
      </div>
